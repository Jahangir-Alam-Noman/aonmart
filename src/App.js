...
function App() {
  ...
  const isStoreModalActive = useSelector((state) => state.GlobalReducer.isStoreModalActive);
  ...
  useEffect(() => {
    if (typeof LocalSearchInfo !== "undefined" && LocalSearchInfo !== null && LocalSearchInfo !== "") {
