...
import { getProductMainCategoryList } from "../productCategories/_redux/Action/ProductCategoriesAction";
...
const Header = ({ setIsMenuOpen, isMenuOpen }) => {
  ...
  const LocalSearchInfo = useSelector((state)=> state.LocationStoreReducer.LocalSearchInfo)
      ...
      <header className="header">
        <div className="header-bottom fixed-totop">
          <div className="row m-0 align-items-center mega-menu-relative">
            <div className="col-md-1 col-2 col-sm-3 p-0">
              <div className="all-catagory-option">
                <span className="bar-btn pointer">
                  <i
            ...
            <div className="col-md-1 col-6 d-none d-md-block">
              <Link to="/">
                <img className="img-fluid headerLogo" src={logo} alt="logo" />
              </Link>
            </div>

            <div className="col-md-10 col-10 col-sm-9 ">
              <div className="menu-area d-lg-flex justify-content-between align-items-center">
                <SearchInput />

                <ul className="site-action d-lg-flex align-items-center justify-content-between pt-2  ml-auto heading_search">
                  <li>
                    {/* input store */}
                    <div
                    ...
                    userData !== "" ? (
                      <Dropdown className="my-account">
                        <Dropdown.Toggle id="dropdown-basic">
                          <i className="fas fa-user mr-1"></i>{singleUserInfo?.name}
                        </Dropdown.Toggle>
                      ...
                      >
                        <i class="fas fa-user mr-2 mt-4"> </i>Sign In
                      </span>
                    )}
                  </li>
                </ul>
