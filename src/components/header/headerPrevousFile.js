    ...
    <React.Fragment>
      <header className="header">
        <div className="header-top d-lg-none">
          <div className="mobile-header fixed-totop">
            <div className="row justify-content-between align-items-center">
              ...
              <div className="col-md-9 col-8 d-flex justify-content-md-between justify-content-center align-items-center">
                <div className="headerLogo pr-3 align-items-center d-md-flex d-none">
                  <Link to="/">
                    <img className="img-fluid py-2" src={logo} alt="logo" />
                  </Link>
                </div>
        ...
        <div className="header-bottom fixed-totop d-none d-xl-block">
          <div className="row m-0 align-items-center mega-menu-relative">
            <div className="col-md-1 p-0 d-none d-xl-block">
            ...
            <div className="col-md-10">
              <div className="menu-area d-none d-xl-flex justify-content-between align-items-center">
                <form className="form-inline top-search justify-content-end">
                  <input
                    ...
                    >
                      ...
                      >
                        {location.map((item, index) => (
                          <div
                            key={index + 1}
                            onClick={() => setSelectedLocation(item.label)}
                          >
                            {item.label}
                          </div>
                        ))}
