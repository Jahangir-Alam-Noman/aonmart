      ...
      <section className="catagory-section py-md-5 py-3">
        <div className="container-fluid">
          ...
          <div className="why_people_choose_us_container_section">
            <div className="row">
              {typeof peopleChooseData !== "undefined" &&
                peopleChooseData !== null &&
                peopleChooseData.length > 0 &&
                peopleChooseData.map((item, index) => (
                  <div className="col-md-4 custom_col_padding" key={index + 1}>
                    <div
